...
interface LatestNewsAiAnalysisButtonProps {
    services: {
...
export const LatestNewsAiAnalysisButton: React.FC<
    LatestNewsAiAnalysisButtonProps
> = ({ services }) => {
    ...
    const handleClick = async () => {
        ...
        setLoading(true);
        try {
            await services.backend.requestLatestNewsAiAnalysis();
    ...
    return (
        ...
        >
            ...
            >
                {loading ? 'AI 분석 중...' : '✨ 최신 뉴스 AI 요약 받기'}
            </button>
        </div>
    );
};
