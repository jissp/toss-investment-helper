...
export class LatestNewsAiAnalysisButtonFeature extends ContentFeature {
    readonly elementId = 'request-latest-news-ai-analysis';
    ...
    private createElement(): HTMLElement {
        const element = this.templateService.getTemplate(
            'src/content/templates/request-latest-news-ai-analysis.button.html',
        ) as HTMLElement;
        ...
        element.addEventListener('click', () => {
            const handle = async () => {
                ...
                await this.backendApiService.requestLatestNewsAiAnalysis();
            };
