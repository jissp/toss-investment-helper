...
import { GLOBAL_COMMODITY_PROMPT_TEMPLATE } from '../prompts';
...
@Injectable()
export class GlobalCommodityTransformer implements Pipe<
    TransformerArgs,
    string
> {
    ...
    transform({ indices }: TransformerArgs): string {
        ...
        return replaceTemplate(GLOBAL_COMMODITY_PROMPT_TEMPLATE, {
            currentDate: new Date().toISOString(),
            assetListPrompt: this.transformForIndices(filteredIndices),
        });
    }
